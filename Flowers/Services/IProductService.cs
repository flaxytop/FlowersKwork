...
namespace Flowers.Services
{
    public interface IProductService
    {
            ...
            /// <returns></returns>
            public Task<ResponseData<ListModel<FN>>> GetProductListAsync(string? categoryNormalizedName, int pageNo = 1);
            /// <summary>
            /// Поиск объекта по Id
            /// </summary>
        ...
        /// <returns></returns>
        Task<ResponseData<FN>> UpdateProductAsync(int id, FN product, IFormFile? formFile);
        ...
        Task GetProductListAsync(int? id);
